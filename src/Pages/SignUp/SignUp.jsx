    ...
    <div className="card bg-base-100 w-full max-w-sm shrink-0 shadow-2xl">
      <div className="card-body">
        <form onSubmit={handleSubmit} className="form">
         ...
         <div className='w-4/5 flex justify-center'> <button className="btn bg-green-600 text-Black w-4/5 mt-4">Signup</button></div>
          
        </form>
<p className='text-green-700'> Already Have acoount? Go to <Link to="/login"> <button 
className="text-red-600 btn bg-green-400">Login</button></Link></p>
